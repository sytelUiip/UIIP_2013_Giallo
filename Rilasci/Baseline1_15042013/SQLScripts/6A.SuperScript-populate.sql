INSERT INTO editoria_gruppo_giallo.account(id,username,password,nome,cognome,email,sigla_redazione,sigla_giornalista) VALUES(seq_id_account.nextval,'admin','admin','Mario','Rossi','admin@editoriagruppogiallo.it','admin',NULL);
INSERT INTO editoria_gruppo_giallo.account(id,username,password,nome,cognome,email,sigla_redazione,sigla_giornalista) VALUES(seq_id_account.nextval,'admin1','admin1','Luca','Verdi','admin1@editoriagruppogiallo.it','admin1',NULL);
