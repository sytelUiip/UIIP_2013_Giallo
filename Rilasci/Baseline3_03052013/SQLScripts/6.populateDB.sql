INSERT INTO editoria_gruppo_giallo.account(username,password,nome,cognome,email,sigla_redazione,sigla_giornalista,stato) VALUES('admin','114cniiuinkmjk72aa1p5807u3','Mario','Rossi','admin@editoriagruppogiallo.it','admin','MR','A');
...
INSERT INTO editoria_gruppo_giallo.funzionalita (sigla_funzionalita,nome_funzionalita,nome_gruppo) VALUES ('SblNot','SbloccaNotizie','GIORNALISTA');
